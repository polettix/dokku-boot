...
dokku-boot.d/
dokku-boot.d/01.upgrade-debian.sh
dokku-boot.d/10.setup-swap.sh
dokku-boot.d/20.install-dokku.sh
dokku-boot.d/21.install-plugins.sh
dokku-boot.d/00.setup-iptables.sh
dokku-boot.d/30.trivial-index.sh
dokku-boot.sh
4 20480
here
dokku-boot.d/                                                                                       0000755 0001751 0001751 00000000000 13314001555 013277  5                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                dokku-boot.d/01.upgrade-debian.sh                                                                   0000755 0001751 0001751 00000000150 12775205734 016737  0                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                #!/bin/bash
set -eo pipefail
