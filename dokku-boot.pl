...
4 10240
here
dokku-boot.d/                                                                                       0000755 0001751 0001751 00000000000 13013716467 013312  5                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                dokku-boot.d/01.upgrade-debian.sh                                                                   0000755 0001751 0001751 00000000150 12775205734 016737  0                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                #!/bin/bash
set -eo pipefail
apt-get -y update || { sleep 5 && apt-get -y update ; }
apt-get -y upgrade
                                                                                                                                                                                                                                                                                                                                                                                                                        dokku-boot.d/10.setup-swap.sh                                                                       0000755 0001751 0001751 00000000642 13013716461 016174  0                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                #!/bin/bash
...
exit 0
                                                                    dokku-boot.sh                                                                                       0000755 0001751 0001751 00000000334 12775570476 013443  0                                                                                                    ustar   poletti                         poletti                                                                                                                                                                                                                #!/bin/bash
